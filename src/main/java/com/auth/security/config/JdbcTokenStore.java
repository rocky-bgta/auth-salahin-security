...
public class JdbcTokenStore implements TokenStore {
	...
	//private final Map<String, OAuth2AccessToken> accessTokens = new HashMap<>();
	//private final Map<String, OAuth2RefreshToken> refreshTokens = new HashMap<>();
	...
	private static final String DEFAULT_AUTHENTICATION_ID_DELETE_STATEMENT= "delete from oauth_access_token where authentication_id=?";
	...
	private String deleteAuthenticationIdSql = DEFAULT_AUTHENTICATION_ID_DELETE_STATEMENT;
	...
	private OAuth2AccessToken enhanceAccessToken(OAuth2AccessToken accessToken) {
		if (accessToken != null) {
...
//	private OAuth2RefreshToken enhanceRefreshToken(OAuth2RefreshToken refreshToken) {
//		if (refreshToken != null) {
//			DefaultOAuth2RefreshToken token = (DefaultOAuth2RefreshToken) refreshToken;
...
//	}
	...
	public void removeAuthenticationToken(String key){
		jdbcTemplate.update(deleteAuthenticationIdSql,key);
	}

	@Override
	public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {

		OAuth2AccessToken enhancedAccessToken = enhanceAccessToken(token);
		token = enhancedAccessToken;
	...
	public OAuth2Authentication readAuthenticationForRefreshToken(String value) {
		...
		try {
			...
			System.out.println(" TokenKey: "+extractTokenKey(value));
		}
		catch (EmptyResultDataAccessException e) {
			if (LOG.isInfoEnabled()) {
